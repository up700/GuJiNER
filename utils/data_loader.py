...
from utils.utils import get_seq_labels
...
processors = {
    "sample": Processor,
    "ner_data": Processor,
    "ner_data_all": Processor,
    "ner_data_pseudo": Processor,
    "ner_data_1": Processor,
    "ner_data_2": Processor,
    "ner_data_3": Processor,
    "ner_data_4": Processor,
    "ner_data_5": Processor,
    "ner_data_aug": Processor,
    "ner_data_know": Processor,
    "ner_data_know_slide": Processor,
    "ner_data_test": Processor,
}
    ...
    for (ex_index, example) in enumerate(examples):
        ...
        for word, seq_label in zip(example.words, example.seq_labels):
            ...
            if not flag:
                ...
                seq_labels_ids.extend([pad_token_label_id] + [pad_token_label_id] * (len(word_tokens) - 1))
        assert len(tokens) == len(seq_labels_ids)
