...
# CUDA_VISIBLE_DEVICES=3 python main.py --task ner_data --model_dir save_model --model_type roberta --do_train --do_eval --num_train_epochs 100 --warmup_steps 200 --learning_rate 2e-5 --use_crf --train_batch_size 16 --dropout_rate 0.05 --gradient_accumulation_steps 2 --logging_steps 100 --max_seq_len 100 --weight_decay 0.001
# CUDA_VISIBLE_DEVICES=1 python main.py --task ner_data --model_dir save_model --model_type roberta --do_train --do_eval --num_train_epochs 100 --warmup_steps 200 --learning_rate 1e-5 --use_crf --train_batch_size 64